...
void Mesh::createMesh(GLfloat *vertices, unsigned int *indeces, unsigned int numOfVertices, unsigned int numOfIndices)
{
    ...
    glBindVertexArray(VAO);
        ...
        glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, IBO);
            glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof (indeces[0]) * numOfIndices, indeces, GL_STATIC_DRAW);
